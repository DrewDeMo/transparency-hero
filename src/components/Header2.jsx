        ...
        <>
            ...
            >
                <div className="container mx-auto px-6 py-6 flex items-center justify-between">
                    ...
                    >
                        <img src={TCLLogo} alt="TCL Logo" className="w-[150px] h-auto sm:w-[223px]" />
                    </motion.div>
                    ...
                    >
                        <div className="w-6 h-6 flex flex-col justify-between items-center">
                            <span className={`w-full h-0.5 bg-gray-800 transform transition-all duration-300 ${isMenuOpen ? 'rotate-45 translate-y-2.5' : ''}`}></span>
            ...
            <AnimatePresence>
                {isMenuOpen && (
                    <motion.div
                        className="fixed inset-0 bg-white/70 backdrop-blur-lg z-40 md:hidden font-montserrat"
                            ...
                            <ul className="space-y-8 text-center">
                                {menuItems.map((item) => (
                                    ...
                                    >
                                        <a
                                            href={`#${item.toLowerCase()}`}
                                            className="text-2xl text-gray-800 hover:text-[#cc5500] focus:text-[#cc5500] focus:outline-none transition-colors"
